...
<body class="hold-transition sidebar-mini">
  ...
  Swal.fire({
    position: 'top-end',
    icon: 'success',
    title: '<h3>Bienvenido <?php echo $nombre_sesion; ?></h3>',
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL; ?>" class="brand-link">
      <img src="<?php echo $URL ?>/public/img/icono_pagina_login.png" alt="Logo de la página principal" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo "Usuario: " . $nombre_sesion; ?></a>
        </div>
      </div>
